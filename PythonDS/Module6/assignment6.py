...
#
# .. your code here ..
X = pd.read_csv('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module6/Datasets/dataset-har-PUC-Rio-ugulino.csv',
                sep = ';')
...
#
# .. your code here ..
X.how_tall_in_meters = X.how_tall_in_meters.apply(lambda x: int(''.join(x.split(','))))
X.body_mass_index = X.body_mass_index.apply(lambda x: int(''.join(x.split(','))))
...
#
# .. your code here ..
y = X['class'].map({'sittingdown': 0, 'sitting': 1, 'standingup': 2, 'standing': 3, 'walking': 4})
