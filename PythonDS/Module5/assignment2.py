...
#
# .. your code here ..
user1b = user1a[(user1a.CallTime < '06:00:00') | (user1a.CallTime > '22:00:00')]
...
user1b.plot.scatter(x='TowerLon', y='TowerLat', c='gray', alpha=0.1, title='Weekend')

#fig = plt.figure()
#ax = fig.add_subplot(111)
#ax.scatter(user1b.TowerLon,user1b.TowerLat, c='g', marker='o', alpha=0.1)
...
#
# .. your code here ..
user1c = user1b[['TowerLon', 'TowerLat']]
kmeans_model = KMeans(n_clusters=1).fit(user1c)
  #
