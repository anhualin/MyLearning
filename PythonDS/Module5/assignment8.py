...
#
# .. your code here ..
X = pd.read_csv('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module5/Datasets/life_expectancy.csv', sep='\t')
...
# .. your code here ..
X_train = X[X['Year'] < 1986][['Year']]
y_train = X[X['Year'] < 1986][['BlackMale']]
X_test = X[X['Year'] >= 1986][['Year']]
y_test = X[X['Year'] >= 1986][['BlackMale']]
model.fit(X_train, y_train)
drawLine(model, X_test, y_test, 'Blackmale')
print X[X['Year'] == 2014]
