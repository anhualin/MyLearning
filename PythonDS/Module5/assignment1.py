...
#
# .. your code here ..
df = pd.read_csv('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module5/Datasets/Crimes_-_2001_to_present.csv')
df = df.dropna(axis = 0)
...
#
# .. your code here ..
df1 = df[df.Date > pd.to_datetime('2011-01-01')]
