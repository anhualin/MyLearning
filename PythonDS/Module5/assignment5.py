...
#
# .. your code here ..
X = pd.read_csv('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module5/Datasets/wheat.data')
...
#
# .. your code here ..
order_wtype = list(set(y.tolist()))
y = y.astype("category", ordered = True, categories = order_wtype).cat.codes
...
for i in range(1, X.shape[1]):
    if X.iloc[:, i].isnull().any():
        X.iloc[:, i].fillna( X.iloc[:, i].mean(), inplace = True)
