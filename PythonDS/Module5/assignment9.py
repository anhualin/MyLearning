...
X_train, X_test, y_train, y_test = train_test_split(Room_Board, Accept, test_size=0.30, random_state=7)
...
Enroll = X['Enroll']
X_train, X_test, y_train, y_test = train_test_split(Enroll, Accept, test_size=0.30, random_state=7)
...
FUndergrad = X['F.Undergrad']
X_train, X_test, y_train, y_test = train_test_split(FUndergrad, Accept, test_size=0.30, random_state=7)
...
RoomEnroll = X[['Room.Board', 'Enroll']]
X_train, X_test, y_train, y_test = train_test_split(RoomEnroll, Accept, test_size=0.30, random_state=7)
