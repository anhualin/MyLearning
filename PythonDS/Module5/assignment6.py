...
#
# .. your code here ..
mat = scipy.io.loadmat('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module4/Datasets/face_data.mat')
...
#
# .. your code here ..
df_label = pd.read_csv('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module5/Datasets/face_labels.csv',
...
if Test_PCA:
  ...
  #
  # .. your code here ..
  imap = Isomap(n_neighbors=8, n_components=2)
  imap.fit(data_train)
  data_train = imap.transform(data_train)
  data_test = imap.transform(data_test)
...
for i in range(1, 21):
    ...
    scores.append((i, knn.score(data_test, label_test)))
