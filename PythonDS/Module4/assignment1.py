...
plyfile = PlyData.read('C:/Users/alin/Documents/SelfStudy/PythonDS/DAT210x/Module4/Datasets/stanford_armadillo.ply')
...
for i in range(5): pca = do_PCA(armadillo)
...
t1 = datetime.datetime.now()
for i in range(5): rpca = do_RandomizedPCA(armadillo)
time_delta = datetime.datetime.now() - t1
