...
y_train1 = mnist.train.labels.astype('int')
y_test = mnist.test.labels.astype('int')
X_train2 = mnist.validation.images
y_train2 = mnist.validation.labels.astype('int')
...
with tf.Session() as sess:
    ...
    saver.save(sess, modeldir + '/my_digit_comparison_model.ckpt')
...
with tf.Session() as sess:
    init.run()
    restore_saver.restore(sess, modeldir + '/my_digit_comparison_model.ckpt')
    for epoch in range(n_epochs):
        ...
        if epoch % 5 == 0:
            ...
            print(epoch, "Test accuracy:", acc_test)
    saver.save(sess, modeldir + '/my_mnist_model_final.ckpt')
